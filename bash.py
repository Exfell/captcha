...
# кароче, что бы я хотел сказать. За счёт того, что всё записывается в ОЗУ, может быть немного плоховато. Вместо этого мы можем сразу записывать в файл, впринципе, но кто знает.
ssh.close()
#78 =